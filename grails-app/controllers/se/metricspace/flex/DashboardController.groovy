...
class DashboardController {
    ...
    def index() {
        ...
        User user = User.findByEppn(sessionUser.getUid())
        ...
        [absences: absences, reportedTimeDelta: reportedTimeDelta, reportedTimes: reportedTimes, timeAdjustmentSum: timeAdjustmentSum, timeAdjustments: timeAdjustments, user: user, workRates: workRates]
    }
}
