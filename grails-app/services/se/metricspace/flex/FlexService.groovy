...
class FlexService {
    ...
    void addWorkRate(String uid, Date fromDate, Date toDate, int rate, String comment) {
        ...
        WorkRate.newInstance(user: user, startDate: fromDate, endDate: toDate, rate: rate, rateMonday: rate, rateTuesday: rate, rateWednesday: rate, rateThursday: rate, rateFriday: rate, comment: comment?.trim()).save(flush: true, failOnError: true)
    }
