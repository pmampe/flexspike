databaseChangeLog = {
  ...
  changeSet(author: "mano3567", id: "1448278733528-11") {
    ...
    sql("insert into time_adjustment(version, date_created, comment, adjustment, user_id) select 0, now(), t.comment, t.delta, u.id as user_id from timeadjustments t inner join user u on u.uid=t.uid;")
