...
<g:else>
  ...
  <div class="row">
    ...
    <div class="col-sm-8"><g:textField name="start" value="${reportedTime?.formatStartTime()}" placeHolder="HH:MM" class="form-control" data-flexdateid="${flexDate.id}"/></div>
  </div>

  <div class="row">
    <div class="col-sm-4"><label for="lunch">Lunch längd (HH:MM):</label></div>
    <div class="col-sm-8"><g:textField name="lunch" value="${reportedTime?.formatLunchLength()}" placeHolder="HH:MM" class="form-control" data-flexdateid="${flexDate.id}"/></div>
  </div>

  <div class="row">
    <div class="col-sm-4"><label for="end">Gick (HH:MM):</label></div>
    <div class="col-sm-8"><g:textField name="end" value="${reportedTime?.formatEndTime()}" placeHolder="HH:MM" class="form-control" data-flexdateid="${flexDate.id}"/></div>
  </div>
