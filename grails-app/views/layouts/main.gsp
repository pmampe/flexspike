      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><g:link controller="dashboard" action="timeAdjustment" title="Justera tid">Justera Flex</g:link></li>
            ...
            <g:if test="${session.sessionUser.getRole()==se.metricspace.flex.Role.SYSADMIN}">
                <li><g:link controller="admin" action="index" title="Admin">Admin</g:link></li>
            </g:if>
            <g:if test="${session.realUser}">
                <li><g:link controller="public" action="unsudo" title="Bli dig själv">Un-Sudo from ${session.sessionUser.eppn}</g:link></li>
            </g:if>
          </ul>
      </div>
    </nav>
