            ...
            <div class="panel-body">
                <table class="table table-bordered table-hover table-responsive table-striped">
                    ...
                    <tbody>
                       ...
                       <tr><td>Absent</td><td>${se.metricspace.flex.Absent.count()}</td><td><g:formatDate date="${se.metricspace.flex.Absent.findByLastUpdatedIsNotNull([sort: 'lastUpdated', order: 'desc', max: 1])?.lastUpdated}" format="yyyy-MM-dd HH:mm"/></td><td><g:link action="initAbsencesFromOldSystem" title="update">Update</g:link></td></tr>
